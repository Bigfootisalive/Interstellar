...
if (nav) {
  ...
  const html = `
    ...
    <div class="fixed-nav-bar-right">
      ...
      <a class="navbar-link" href="/./tools.html"><i class="fa-solid fa-folder navbar-icon"></i><an>To</an><an>ols</an></a>
      ${window.top.location.pathname === "/tabs.html" ? "" : '<a class="navbar-link" href="/./tabs.html"><i class="fa-solid fa-laptop navbar-icon"></i><an>Ta</an><an>bs</an></a>'}
      <a class="navbar-link" href="/./settings.html"><i class="fa-solid fa-gear navbar-icon settings-icon"></i><an>Set</an><an>tings</an></a>
    </div>`;
  nav.innerHTML = html;
}
